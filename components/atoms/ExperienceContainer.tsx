  ...
  return (
    <section className=" rounded-lg ">
      {props.experiences.map((experience) => (
        <div
          key={experience.id}
          className="mb-4 flex group flex-wrap max-w-full rounded-md  bg-secondary p-2"
        >
      ...
      <Link
        className="p-4 mb-4 align-middle flex items-center justify-center rounded-md bg-secondary"
        href={"/experience"}
      >
        <svg
