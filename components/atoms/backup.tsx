...
// import { Project, Experience, Message } from "@/types/global";
...
//     //   (item && item.data && item.data.projects) || [];
...
//               <Link
//                 className="text-xs bg-gray-200 hover:bg-black text-gray-500 hover:text-gray-200 px-2 py-1 rounded-lg transition duration-200 cursor-default m-1"
//                 href={""}
//               >
//                 update
//               </Link>
